...
class Home extends Component {
            ...
            fetch(item.url)
                ...
                .then((result) => {
                    this.setState({
                        ...
                        pokemonsDetailDefault: [...this.state.pokemonsDetailDefault, result].sort((a, b) => a.id - b.id)
                    })
                })
        })
    }
    ...
    filterPokemons = serchWord => {
        this.setState({
            pokemonsDetail: this.state.pokemonsDetailDefault.filter((item) => item.name.includes(serchWord))
        })
    }
    render() {
