...
const PopUpPokemonDetail = props => {
    const { pokemon } = props;
    const pokemonHeight = pokemon.height.toString().length 
    const pokemonHeightCount = pokemon.height.toString().length = 1 ? '0,' + pokemon.height : pokemon.height.toString()[0] + ',' + pokemon.height.toString()[1]
    console.log(pokemonHeight);
    console.log(pokemonHeightCount);
    return (
            ...
            <div className={'pokemon-detail'}>
                ...
                <div className={'pokemon-detail-content'}>
                    ...
                    <div className={'pokemon-detail-description-box'}>
                        ...
                        <div><b> Height:</b> {pokemon.height} <b>Weight:</b> {pokemon.weight}</div>
                    </div>
                </div>
            </div>
        </div>
