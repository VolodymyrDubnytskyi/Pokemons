            ...
            <div className={'pop-up-detail-bg'}>
                ...
                <div className={'pokemon-detail'}>
                    <nav className={'pokemon-detail-menu'} onClick={this.menuTabs}>
                        <div className={'pokemon-detail-menu-item pokemon-detail-menu-active-item'} data-id='1'>Basic Info</div>
                        <div className={'pokemon-detail-menu-item'} data-id='2'>Stats</div>
                        <div className={'pokemon-detail-menu-item'} data-id='3'>Abilities</div>
                    </nav>
