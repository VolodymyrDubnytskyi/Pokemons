                            ...
                            {this.state.pokemonsDetail.map((item, i) => {
                                return (
                                    <div
                                        ...
                                        key={i}
                                    >
                                        <img src={'https://purepng.com/public/uploads/thumbnail/purepng.com-pokeballpokeballdevicepokemon-ballpokemon-capture-ball-1701527825861ghxff.png'} alt="pokemon-image" onLoad={this.loadingPokemonImg}/>
