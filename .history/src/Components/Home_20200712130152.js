...
class Home extends Component {
    ...
    loadingPokemonImg = pokeIndex =>{
        this.setState({
            imgLoaded: this.state.imgLoaded.push(pokeIndex)
        })
    }
    render() {
        console.log(imgPokeball)
        return (
                            ...
                            {this.state.pokemonsDetail.map((item, i) => {
                                return (
                                    <div
                                        ...
                                        key={i}
                                    >
                                        <img src={this.state.imgLoaded.includes(i) ? item.sprites.front_default : imgPokeball} alt="pokemon-image" onLoad={()=>this.loadingPokemonImg(i)}/>
