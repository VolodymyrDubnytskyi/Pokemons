                            ...
                            {this.state.pokemonsDetail.map((item, i) => {
                                return (
                                    <div
                                        ...
                                        key={i}
                                    >
                                        <img src={'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTPstImz24mPJkak41XibQanseY26c9PwPDxw&usqp=CAU'} alt="pokemon-image" onLoad={this.loadingPokemonImg}/>
